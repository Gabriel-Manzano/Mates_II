function crearInputFuncion(funcion) {
    ...
    var funcionDiv = document.getElementById("funcion");
    var transformadaDiv = document.getElementById("transformada");
    var inputs = '';
    
    // Establecer la función seleccionada en el div "funcion"
    funcionDiv.innerHTML = '\\[' + funcion + '\\]';
    // Establecer la transformada correspondiente en el div "transformada"
    transformadaDiv.innerHTML = '\\[ \\mathcal{L}\\{' + funcion + '\\} \\]';
...
function calcularFuncion(funcion) {
    ...
    var valorN = document.getElementById("valorN") ? document.getElementById("valorN").value : "";
    var funcionF = document.getElementById("funcionF") ? document.getElementById("funcionF").value : "";
    var sustitucionDiv = document.getElementById("sustitucion");
    ...
    // Actualizar el div de sustitución
    if (funcion === 't^n') {
        sustitucionDiv.innerHTML = '\\[ t^{' + valorN + '} \\]';
    } else if (funcion === 'e^{at}') {
        sustitucionDiv.innerHTML = '\\[ e^{' + valorA + 't} \\]';
    } else if (funcion === '\\cos(bt)') {
        sustitucionDiv.innerHTML = '\\[ \\cos(' + valorB + 't) \\]';
    } else if (funcion === '\\sin(bt)') {
        sustitucionDiv.innerHTML = '\\[ \\sin(' + valorB + 't) \\]';
    } else if (funcion === '\\sinh(bt)') {
        sustitucionDiv.innerHTML = '\\[ \\sinh(' + valorB + 't) \\]';
    } else if (funcion === '\\cosh(bt)') {
        sustitucionDiv.innerHTML = '\\[ \\cosh(' + valorB + 't) \\]';
    } else if (funcion === 'e^{at} \\cos(bt)') {
        sustitucionDiv.innerHTML = '\\[ e^{' + valorA + 't} \\cos(' + valorB + 't) \\]';
    } else if (funcion === 'e^{at} \\sin(bt)') {
        sustitucionDiv.innerHTML = '\\[ e^{' + valorA + 't} \\sin(' + valorB + 't) \\]';
    } else if (funcion === '\\delta(t - a)') {
        sustitucionDiv.innerHTML = '\\[ \\delta(t - ' + valorA + ') \\]';
    } else if (funcion === 'u(t - a)') {
        sustitucionDiv.innerHTML = '\\[ u(t - ' + valorA + ') \\]';
    } else if (funcion === '1') {
        sustitucionDiv.innerHTML = '\\[ 1 \\]';
    } else if (funcion === 't') {
        sustitucionDiv.innerHTML = '\\[ t \\]';
    } else if (funcion === 't^2') {
        sustitucionDiv.innerHTML = '\\[ t^2 \\]';
    } else if (funcion === '\\frac{1}{t}') {
        sustitucionDiv.innerHTML = '\\[ \\frac{1}{t} \\]';
    } else if (funcion === 't e^{at}') {
        sustitucionDiv.innerHTML = '\\[ t e^{at} \\]';
    } else if (funcion === 't^n e^{at}') {
        sustitucionDiv.innerHTML = '\\[ t^{' + valorN + '} e^{' + valorA + 't} \\]';
    } else if (funcion === 'sinh(at) \\cosh(bt)') {
        sustitucionDiv.innerHTML = '\\[ \\sinh(' + valorA + 't) \\cosh(' + valorB + 't) \\]';
    } else if (funcion === 'cosh(at) \\sinh(bt)') {
        sustitucionDiv.innerHTML = '\\[ \\cosh(' + valorA + 't) \\sinh(' + valorB + 't) \\]';
    } else if (funcion === '\\int_{0}^{t} f(\\tau) d\\tau') {
        sustitucionDiv.innerHTML = '\\[ \\int_{0}^{' + valorT + '} ' + funcionF + ' d\\tau \\]';
    } else if (funcion === 'f\'(t)') {
        sustitucionDiv.innerHTML = '\\[ f\'(t) \\]';
    } else if (funcion === 'f\'\'(t)') {
        sustitucionDiv.innerHTML = '\\[ f\'\'(t) \\]';
    } else if (funcion === 'e^{bt} t^n') {
        sustitucionDiv.innerHTML = '\\[ e^{' + valorB + 't} t^{' + valorN + '} \\]';
    } else if (funcion === 't \\sin(at)') {
        sustitucionDiv.innerHTML = '\\[ t \\sin(' + valorA + 't) \\]';
    } else if (funcion === 't \\cos(at)') {
        sustitucionDiv.innerHTML = '\\[ t \\cos(' + valorA + 't) \\]';
    } else if (funcion === '\\sin(at + b)') {
        sustitucionDiv.innerHTML = '\\[ \\sin(' + valorA + 't + ' + valorB + ') \\]';
    } else if (funcion === '\\cos(at + b)') {
        sustitucionDiv.innerHTML = '\\[ \\cos(' + valorA + 't + ' + valorB + ') \\]';
    }
